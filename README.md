...
Block 52 is an efficient protocol to facilitate trustless player to player card games over the internet, with zero knowledge and no central authority.  Block 52 is an implmentaiton of many "mental poker" protocols made possible with its own proof of stake blockchain.
